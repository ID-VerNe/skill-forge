...
`polyglot/router.py` dispatches to subcommands: scout, audit, analyze, list, cross-search, discover, cap-list, cap-match, bridge, strategies, mvp-scope, and all deep-* commands. Subcommands route to the corresponding module in `polyglot/commands/`.
