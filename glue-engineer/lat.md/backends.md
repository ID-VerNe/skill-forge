...
### Retry and Cache Pattern

All scout backends use a unified retry-and-cache pattern: cache-first, retry-on-miss, stale fallback on network failure.

Reference: [[polyglot/common/cache.py]], [[polyglot/common/retry.py]]
